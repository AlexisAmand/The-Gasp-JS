...
<section class="container">		
	...
	<article class="col-md-12 bg-white">
		...
		<h4 class="mt-4"><?php echo IND_TITLE; ?></h4>
            ...
            <button type="button" class="btn btn-primary mx-auto my-5" href="#" data-bs-toggle="modal" data-bs-target="#ModalNouvellePartie"><?php echo IND_START; ?></button>
			...
			for ($i=1;$i<5;$i++)
				...
				<a href="#" data-bs-toggle="modal" data-bs-target="#modalecapture0'.$i.'" title="Capture d\'écran du jeu de carte solitaire sur navigateur Le Gasp">
